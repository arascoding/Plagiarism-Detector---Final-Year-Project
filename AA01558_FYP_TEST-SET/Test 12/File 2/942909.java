...
other
Links  = 0;
  public final static int Rechts = 1;
...
mMouseX;
  ...
  public static Image     Grummel;
	...
	public static void main( String[] argumente)
	{
		...
		toolkit.prepareImage( Grummel, 50, 50, myFenster);
  ...
  public void paint( Graphics g)
  {
    ...
    g.
other
setColor( mColors[mRichtungsFarbe[ mRichtung ]]);
...
for ( int i = 0; i < 4 ; i++)
  ...
  public static void newJumper()
  {
    ...
    mXPos 
other
= (int) Math.round( mZufall.nextDouble() * 300 + 50);
