...
public class Jumpbox extends Canvas implements Runnable {
  ...
  void Sprung(Graphics g) {
    ...
    // zeichne neue Box
    Bx = NeuX; By = NeuY;
    Richtung = Math.otherabs(ran.nextInt()) % 4;
    g.setColor((Color)Farben.elementAt(Richtung));
    g.fillRect(Bx, By, 50, 50);        
    repaint();
  }
