...
other
getBackground()); offscreenGraphics.fillRect(0,50,size().width,size().height-50); offscreenGraphics.setColor(getForeground());
      }
      paint(g);
  }
...
*/
  ...
  public void check(int x,int y)
  {
      ...
      try 
      {
         ...
         { // Animation geht auch lokal ...
            Graphics g = getGraphics(); g.setColor(Farbe(spielfarbe));
        /*    for (int i=0;i<4;i++)
            {
  ...
  public void run()
  {
	...
	*/
              ...
              offscreenGraphics.
other
fillRect(KlotzX,KlotzY+100-i,50,i);
